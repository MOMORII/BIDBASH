...
This repository contains the source code, development artefacts, supporting documentation, and evaluation materials produced for **BIDBASH**, that is a Final Year Project (FYP) developed as part of an undergraduate (BEng) SoftEng degree.
